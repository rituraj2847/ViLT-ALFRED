...
from eval_task_v2 import EvalTask2
...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_split', type=str, default='valid_unseen', choices=['train', 'valid_seen', 'valid_unseen'])
